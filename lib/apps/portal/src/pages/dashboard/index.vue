...
<template>
    <div class="min-h-screen flex flex-col relative">
        ...
        <div class="p-8 flex-grow flex flex-col lg:h-screen">
            <div class="flex flex-col gap-6 flex-grow w-full h-full lg:grid lg:grid-cols-12 lg:grid-rows-3">
                <!-- info -->
                <InfoPanel class="col-span-12 row-start-1 col-start-1 md:col-span-12 lg:col-span-5 row-span-1">
                </InfoPanel>
                <!-- messenger -->
                <MessengerPanel
