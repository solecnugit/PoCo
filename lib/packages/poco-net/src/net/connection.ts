...
export type PocoConnectionEvents = {
    "status": (this: ThisType<PocoConnection<PocoConnectionEvents>>, status: PocoConnectionStatus) => void;
    "connected": (this: ThisType<PocoConnection<PocoConnectionEvents>>) => void;
    "disconnected": (this: ThisType<PocoConnection<PocoConnectionEvents>>, reason: PocoConnectionClosedReason) => void;
    "message": (this: ThisType<PocoConnection<PocoConnectionEvents>>, message: PocoMessagePayload) => void;
    "error": (this: ThisType<PocoConnection<PocoConnectionEvents>>, error: string) => void;
}
...
> extends EventDispatcher<Events, ReservedEvents> {
    ...
    abstract send<Event extends ReservedOrUserEventNames<ReservedEvents, Events>>
        (type: Event, ...payload: any): Promise<void> | void;
}
